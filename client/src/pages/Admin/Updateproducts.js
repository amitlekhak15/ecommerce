...
const Updateproducts = () => {
  ...
  const getSingleProduct = async () => {
    try {
      const { data } = await axios.get(
        `http://localhost:8080/api/v1/products/getallproducts/${params.slug}`
      );
  ...
  const handleDelete = async () => {
    try {
      ...
      if (!answer) return;
      const { data } = await axios.delete(` http://localhost:8080/api/v1/products//deleteproduct/${id}`
            ...
            <div className="m-1 w-75">
              ...
              <div className="mb-3">
                {photo ? (
                  ...
                  <div className="text-center">
                    <img
                      src={`http://localhost:8080/api/v1/products/productphoto/${id}`}
                      alt="product_photo"
                      height={"200px"}
                      className="img img-responsive"
                    />
